...
supplement.pdf: categories.tex comparison_with_mma.tex diophantine.tex examples.tex gamma.tex gruntz.tex logic.tex nsimplify.tex polys.tex series.tex sets.tex stats.tex supplement.tex tensors.tex paper.bib images/integral_steps.png
