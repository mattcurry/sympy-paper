...
Julia, ...) whose aim is to be the fastest manipulation library.  Preliminary
benchmarks suggest that SymEngine is as fast or faster than the commercial or
open source competitors.

SymPy recently started to use SymEngine as an optional backend, initially in
\texttt{sympy.mechanics} only. The plan is to allow more algorithms in SymPy to
take advantage of the speed of SymEngine.
