...
\hypersetup{
  colorlinks=true,
  linkcolor=black, % color of internal links. Black because the cross-document
...
\end{verbatim}
  ...
  We have opened an \href{https://github.com/sympy/sympy/issues/11539}{issue}
  about this in our issue tracker.
\end{solution}
