...
\begin{quote}
In SymPy, \texttt{str(expr) == repr(expr)}.  In other words,
...
see the exact form of an expression.
\end{quote}
\end{solution}
...
\end{quote}
We use here same terminology as in the Mathematica
online documentation, e.g. OutputForm function.
\end{solution}
...
\begin{solution}
We have left this as is (see the discussion at~\ref{rev1point37}).
\end{solution}
...
\href{https://docs.python.org/3/tutorial/modules.html#packages} and
\href{https://docs.python.org/3/glossary.html#term-package}). The distinction
