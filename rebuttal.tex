...
We have added a sentence to the section 5.1, that shows symbolic
...
was replaced with a better reference [32], that illustrates our point.
\end{solution}
\end{questions}
...
\begin{solution}
We have added a footnote about the \texttt{dotprint} function (footnote 12),
...
text in the section 5.1, ``The Core''.
\end{solution}
...
\begin{quote}
  ...
  used to recreate the expression. As it was noted in section~5.1,
