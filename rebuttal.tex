...
\begin{solution}
Major advantage is that mpmath is a pure Python library.  It's slow c.f.
MPFR, but not too much to evaluate any reasonably complicated single
expression at interactive speed, which covers most use cases in SymPy.

We mention this at the beginning of the section.
\end{solution}
...
\begin{solution}
The IEEE defines the term feature in IEEE 829 as "A distinguishing
