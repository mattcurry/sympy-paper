...
imported in your global namespace: exp function from the math
library or exp class from the SymPy.  In later case a special
...
\begin{quote}
Symbols or symbolic constants, like $e$ or $\pi$ are another examples of
leaf nodes.
\begin{verbatim}
>>> exp(1)
E
