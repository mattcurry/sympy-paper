...
The architecture is one of the most important parts of the paper. The goal of
the paper is to discuss the architecture core features of SymPy. We therefore
strongly feel that this section belongs in the main manuscript, and not the
supplementary material. We have followed the reviewer's advice and moved the
architecture section to the end of the paper, to make the paper easier to
follow.
\end{solution}
\end{questions}
