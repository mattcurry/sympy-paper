...
version 1.0, examples in section~\ref{sec:mpmath} use mpmath
version 0.19.
...
executed:\footnote{Three greater-than signs denote standard
Python prompt for interactive session.}
