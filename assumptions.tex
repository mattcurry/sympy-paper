...
integral. SymPy is careful to never perform simplifications on an expression
...
algorithm~\cite{doorenbos1995production}.\footnote{For historical reasons,
  this algorithm is distinct from the \texttt{sympy.logic} submodule, which is
  discussed in the supplementary material. SymPy has an experimental
